...
def load_langpairkey_dataset(
    ...
    key_datasets = indexed_dataset.IndexedRawKeyDataset(os.path.join(data_path, '{}.{}'.format(split, key)))
...
@register_task('translation_key')
class TranslationKeyTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, epoch=0, combine=False, **kwargs):
        ...
        self.datasets[split] = load_langpairkey_dataset(
...
@register_task('translationkey_mass')
class TranslationKeyMASSTask(TranslationKeyTask):
    def __init__(self, args, src_dict, tgt_dict):
        super().__init__(args, src_dict, tgt_dict)
